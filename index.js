...
(function($PS) {
  ...
  var MonadLogger = function (MonadEffect0, log) {
  ...
  exports["MonadLogger"] = MonadLogger;
  exports["info"] = info;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
...
(function($PS) {
  ...
  var newtypeLoggerT = new Data_Newtype.Newtype(function (n) {
      return n;
  }, LoggerT);
  var monadTransLoggerT = new Control_Monad_Trans_Class.MonadTrans(function (dictMonad) {
      return function ($36) {
          return LoggerT(Data_Function["const"]($36));
      };
  });
  var mapLoggerT = function (f) {
      return function (v) {
          return LoggerT(function ($37) {
              return f(v($37));
          });
      };
  };
          ...
          return function (f) {
              return function (l) {
                  return Control_Bind.bind(dictMonad.Bind1())(v(l))((function () {
                      var $40 = Data_Newtype.unwrap(newtypeLoggerT);
                      return function ($41) {
                          return (function (v1) {
                              return v1(l);
                          })($40(f($41)));
  ...
  var applyLoggerT = function (dictMonad) {
      ...
      }, Control_Monad.ap(monadLoggerT(dictMonad)));
  };
  var applicativeLoggerT = function (dictMonad) {
      return new Control_Applicative.Applicative(function () {
          return applyLoggerT(dictMonad);
      }, (function () {
          var $42 = Control_Applicative.pure(dictMonad.Applicative0());
          return function ($43) {
              return LoggerT(Data_Function["const"]($42($43)));
          };
      })());
  };
  var monadAskLoggerT = function (dictMonadAsk) {
      ...
      }, Control_Monad_Trans_Class.lift(monadTransLoggerT)(dictMonadAsk.Monad0())(Control_Monad_Reader_Class.ask(dictMonadAsk)));
  };
  var monadEffectLoggerT = function (dictMonadEffect) {
      return new Effect_Class.MonadEffect(function () {
          return monadLoggerT(dictMonadEffect.Monad0());
      }, (function () {
          var $46 = Control_Monad_Trans_Class.lift(monadTransLoggerT)(dictMonadEffect.Monad0());
  ...
  var monadAffLoggerT = function (dictMonadAff) {
      return new Effect_Aff_Class.MonadAff(function () {
          ...
          var $49 = Control_Monad_Trans_Class.lift(monadTransLoggerT)((dictMonadAff.MonadEffect0()).Monad0());
          var $50 = Effect_Aff_Class.liftAff(dictMonadAff);
          return function ($51) {
              return $49($50($51));
          };
      })());
  ...
  var monadLoggerLoggerT = function (dictMonadEffect) {
      return new Control_Monad_Logger_Class.MonadLogger(function () {
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Data.Log.Filter"] = $PS["Data.Log.Filter"] || {};
  var exports = $PS["Data.Log.Filter"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Data_Log_Level = $PS["Data.Log.Level"];
  var Data_Ord = $PS["Data.Ord"];
  var Data_Unit = $PS["Data.Unit"];                
...
(function($PS) {
  "use strict";
  $PS["Verbosity"] = $PS["Verbosity"] || {};
  var exports = $PS["Verbosity"];
  var Data_Show = $PS["Data.Show"];                
  ...
  var showVerbosity = new Data_Show.Show(function (v) {
      if (v instanceof Silent) {
          return "silent";
      };
      ...
      throw new Error("Failed pattern match at Verbosity (line 13, column 12 - line 16, column 21): " + [ v.constructor.name ]);
  });
  exports["Silent"] = Silent;
  exports["Info"] = Info;
  exports["Debug"] = Debug;
  exports["showVerbosity"] = showVerbosity;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  ...
  var Control_Monad_Reader_Trans = $PS["Control.Monad.Reader.Trans"];
  var Data_Function = $PS["Data.Function"];
  var Data_Log_Filter = $PS["Data.Log.Filter"];
  ...
  var Verbosity = $PS["Verbosity"];                
  var AppM = function (x) {
      return x;
  };
  var runAppM = function (v) {
      return function (options) {
          var logMessage = Control_Bind.composeKleisli(Control_Monad_Reader_Trans.bindReaderT(Effect_Aff.bindAff))(Data_Log_Formatter_Pretty.prettyFormatter(Control_Monad_Reader_Trans.monadEffectReader(Effect_Aff.monadEffectAff)))(Effect_Class_Console.log(Control_Monad_Reader_Trans.monadEffectReader(Effect_Aff.monadEffectAff)));
          var filterByVerbosity = (function () {
              if (options.verbosity instanceof Verbosity.Info) {
                  return Data_Log_Filter.minimumLevel(Control_Monad_Reader_Trans.monadEffectReader(Effect_Aff.monadEffectAff))(Data_Log_Level.Info.value);
              };
              if (options.verbosity instanceof Verbosity.Debug) {
                  return Data_Log_Filter.minimumLevel(Control_Monad_Reader_Trans.monadEffectReader(Effect_Aff.monadEffectAff))(Data_Log_Level.Debug.value);
              };
              if (options.verbosity instanceof Verbosity.Silent) {
                  return Data_Function["const"](Data_Function["const"](Control_Applicative.pure(Control_Monad_Reader_Trans.applicativeReaderT(Effect_Aff.applicativeAff))(Data_Unit.unit)));
              };
              throw new Error("Failed pattern match at AppM (line 51, column 23 - line 54, column 50): " + [ options.verbosity.constructor.name ]);
          })();
          return Control_Monad_Reader_Trans.runReaderT(Control_Monad_Logger_Trans.runLoggerT(v)(filterByVerbosity(logMessage)))(options);
      };
  };                                                                                                                                        
  var monadLoggerAppM = Control_Monad_Logger_Trans.monadLoggerLoggerT(Control_Monad_Reader_Trans.monadEffectReader(Effect_Aff.monadEffectAff));
  var monadEffectAppM = Control_Monad_Logger_Trans.monadEffectLoggerT(Control_Monad_Reader_Trans.monadEffectReader(Effect_Aff.monadEffectAff));
  var monadAppM = Control_Monad_Logger_Trans.monadLoggerT(Control_Monad_Reader_Trans.monadReaderT(Effect_Aff.monadAff));
  var monadAskAppM = function (dictTypeEquals) {
      return new Control_Monad_Reader_Class.MonadAsk(function () {
          return monadAppM;
      }, AppM(Control_Monad_Reader_Class.asks(Control_Monad_Logger_Trans.monadAskLoggerT(Control_Monad_Reader_Trans.monadAskReaderT(Effect_Aff.monadAff)))(Type_Equality.from(dictTypeEquals))));
  };
  var monadAffAppM = Control_Monad_Logger_Trans.monadAffLoggerT(Effect_Aff_Class.monadAffReader(Effect_Aff_Class.monadAffAff)); 
  var bindAppM = Control_Monad_Logger_Trans.bindLoggerT(Control_Monad_Reader_Trans.monadReaderT(Effect_Aff.monadAff));
  exports["runAppM"] = runAppM;
  exports["bindAppM"] = bindAppM;
  exports["monadEffectAppM"] = monadEffectAppM;
  exports["monadAffAppM"] = monadAffAppM;
  exports["monadLoggerAppM"] = monadLoggerAppM;
...
(function($PS) {
  ...
  var TypeScriptTypeLevel = (function () {
      function TypeScriptTypeLevel() {

      };
      TypeScriptTypeLevel.value = new TypeScriptTypeLevel();
      return TypeScriptTypeLevel;
  })();
  exports["PureScript"] = PureScript;
  exports["Elm"] = Elm;
  exports["ReasonML"] = ReasonML;
  exports["TypeScript"] = TypeScript;
  exports["TypeScriptTypeLevel"] = TypeScriptTypeLevel;
})(PS);
(function(exports) {
  "use strict";
...
(function($PS) {
  ...
  var Options_Applicative_Types = $PS["Options.Applicative.Types"];
  var Verbosity = $PS["Verbosity"];                
  var verbosityParser = Options_Applicative_Builder.eitherReader(function (v) {
      if (v === "silent") {
          return new Data_Either.Right(Verbosity.Silent.value);
      };
      if (v === "info") {
          return new Data_Either.Right(Verbosity.Info.value);
      };
      if (v === "debug") {
          return new Data_Either.Right(Verbosity.Debug.value);
      };
      return Data_Either.Left.create("\"" + (v + "\" is not a valid verbosity level"));
  });
  var langParser = Options_Applicative_Builder.eitherReader(function (v) {
      if (v === "purescript") {
          return new Data_Either.Right(Lang.PureScript.value);
      };
      if (v === "reasonml") {
          return new Data_Either.Right(Lang.ReasonML.value);
      };
      if (v === "elm") {
          return new Data_Either.Right(Lang.Elm.value);
      };
      if (v === "typescript") {
          return new Data_Either.Right(Lang.TypeScript.value);
      };
      if (v === "typescript-type-level") {
          return new Data_Either.Right(Lang.TypeScriptTypeLevel.value);
      };
      return Data_Either.Left.create("\"" + (v + "\" is not a valid lang"));
  });
  var optionsParser = Control_Apply.apply(Options_Applicative_Types.parserApply)(Control_Apply.apply(Options_Applicative_Types.parserApply)(Control_Apply.apply(Options_Applicative_Types.parserApply)(Control_Apply.apply(Options_Applicative_Types.parserApply)(Control_Apply.apply(Options_Applicative_Types.parserApply)(Data_Functor.map(Options_Applicative_Types.parserFunctor)(function (v) {
      return function (v1) {
          return function (v2) {
              return function (v3) {
                  return function (v4) {
  ...
  })(Options_Applicative_Builder.strOption(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder["long"](Options_Applicative_Builder_Internal.optionFieldsHasName)("config"))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder["short"](Options_Applicative_Builder_Internal.optionFieldsHasName)("c"))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.metavar(Options_Applicative_Builder_Internal.optionFieldsHasMetavar)("FILEPATH"))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.value(Options_Applicative_Builder_Internal.optionFieldsHasValue)(""))(Options_Applicative_Builder.help("tailwind.config.js path"))))))))(Options_Applicative_Builder.option(langParser)(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder["long"](Options_Applicative_Builder_Internal.optionFieldsHasName)("lang"))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder["short"](Options_Applicative_Builder_Internal.optionFieldsHasName)("l"))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.metavar(Options_Applicative_Builder_Internal.optionFieldsHasMetavar)("LANG"))(Options_Applicative_Builder.help("Language used in generated code (elm|reasonml|typescript|typescript-type-level|purescript)")))))))(Options_Applicative_Builder.strOption(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder["long"](Options_Applicative_Builder_Internal.optionFieldsHasName)("output"))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder["short"](Options_Applicative_Builder_Internal.optionFieldsHasName)("o"))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.metavar(Options_Applicative_Builder_Internal.optionFieldsHasMetavar)("DIRPATH"))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.showDefault(Data_Show.showString))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.value(Options_Applicative_Builder_Internal.optionFieldsHasValue)("./src"))(Options_Applicative_Builder.help("Directory for generated code")))))))))(Options_Applicative_Builder.strOption(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder["long"](Options_Applicative_Builder_Internal.optionFieldsHasName)("cssOutput"))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.metavar(Options_Applicative_Builder_Internal.optionFieldsHasMetavar)("FILEPATH"))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.showDefault(Data_Show.showString))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.value(Options_Applicative_Builder_Internal.optionFieldsHasValue)("./tailwind.css"))(Options_Applicative_Builder.help("Provide full path (including file name) for generated css stylesheet"))))))))(Options_Applicative_Builder.strOption(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder["long"](Options_Applicative_Builder_Internal.optionFieldsHasName)("cssInput"))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.metavar(Options_Applicative_Builder_Internal.optionFieldsHasMetavar)("FILEPATH"))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.showDefault(Data_Show.showString))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.value(Options_Applicative_Builder_Internal.optionFieldsHasValue)(Node_Globals["__dirname"] + "/assets/input.css"))(Options_Applicative_Builder.help("Provide path of your css stylesheet which uses the @tailwind directive to inject Tailwind's preflight and utilities styles into your CSS"))))))))(Options_Applicative_Builder.option(verbosityParser)(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder["long"](Options_Applicative_Builder_Internal.optionFieldsHasName)("verbosity"))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder["short"](Options_Applicative_Builder_Internal.optionFieldsHasName)("v"))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.metavar(Options_Applicative_Builder_Internal.optionFieldsHasMetavar)("VERBOSITY"))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.value(Options_Applicative_Builder_Internal.optionFieldsHasValue)(Verbosity.Info.value))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.showDefault(Verbosity.showVerbosity))(Options_Applicative_Builder.help("Set verbosity level (silent|info|debug)"))))))));
  var options = Options_Applicative_Builder.info(Options_Applicative_Internal_Utils.apApplyFlipped(Options_Applicative_Types.parserApply)(optionsParser)(Options_Applicative_Extra.helper))(Options_Applicative_Builder.header("Generates code and css from a tailwind config file."));
...
(function($PS) {
  ...
  var Node_Process = $PS["Node.Process"];                
  var mkdirp = function (dictMonadEffect) {
      var $4 = Effect_Class.liftEffect(dictMonadEffect);
      var $5 = Effect_Uncurried.runEffectFn1($foreign["_mkdirp"]);
      return function ($6) {
          return $4($5($6));
      };
  };
  var kill = function (dictMonadEffect) {
      return function (error) {
          return Control_Bind.discard(Control_Bind.discardUnit)((dictMonadEffect.Monad0()).Bind1())(Effect_Class_Console.log(dictMonadEffect)("An error occured: " + Data_Show.show(Effect_Exception.showError)(error)))(function () {
              return Effect_Class.liftEffect(dictMonadEffect)(Node_Process.exit(1));
          });
      };
  };
  var tailwindBuild = function (dictMonadAff) {
      return function (config) {
          return function (cssInput) {
              var $7 = Effect_Aff_Class.liftAff(dictMonadAff);
              var $8 = Data_Function.flip(Control_Monad_Error_Class.catchError(Effect_Aff.monadErrorAff))(kill(Effect_Aff.monadEffectAff));
              var $9 = Effect_Uncurried.runEffectFn3($foreign["_tailwindBuild"])(config)(cssInput);
              return function ($10) {
                  return $7($8(Control_Promise.toAffE($9($10))));
              };
          };
      };
  };
  var getClassNames = function (cssContent) {
      return Data_Function_Uncurried.runFn2($foreign["_getClassNames"])(cssContent);
  };
  var catchAndKill = function (dictMonadEffect) {
      var $11 = Effect_Class.liftEffect(dictMonadEffect);
      var $12 = Effect_Exception.catchException((function () {
          var $14 = Effect_Class.liftEffect(Effect_Class.monadEffectEffect);
          var $15 = kill(Effect_Class.monadEffectEffect);
          return function ($16) {
              return $14($15($16));
          };
      })());
  ...
  exports["catchAndKill"] = catchAndKill;
...
(function($PS) {
  ...
  var Text_Parsing_StringParser_Combinators = $PS["Text.Parsing.StringParser.Combinators"];
  var Utils = $PS["Utils"];                
  var PseudoAst = function (x) {
      return x;
  };                        
  var nodeFromClassName = function (className) {
      var anyValidAndSpecialChar = Text_Parsing_StringParser_Combinators.choice(Data_Foldable.foldableArray)([ Data_Functor.map(Text_Parsing_StringParser.functorParser)(Data_Function["const"]("-neg-"))(Text_Parsing_StringParser_CodeUnits.string("\\\\:-")), Data_Functor.map(Text_Parsing_StringParser.functorParser)(Data_Function["const"]("-over-"))(Text_Parsing_StringParser_CodeUnits.string("\\\\/")), Data_Functor.map(Text_Parsing_StringParser.functorParser)(Data_Function["const"]("-"))(Text_Parsing_StringParser_CodeUnits.string("\\\\:")), Data_Functor.map(Text_Parsing_StringParser.functorParser)(Data_String_CodeUnits.singleton)(Text_Parsing_StringParser_CodeUnits.alphaNum), Text_Parsing_StringParser_CodeUnits.string("-") ]);
      var nameParser = Control_Apply.apply(Text_Parsing_StringParser.applyParser)(Data_Functor.map(Text_Parsing_StringParser.functorParser)(function (v) {
          return function (v1) {
              return v + v1;
          };
      })(Data_Functor.map(Text_Parsing_StringParser.functorParser)(Data_Maybe.maybe("")(Data_Function["const"]("neg-")))(Text_Parsing_StringParser_Combinators.optionMaybe(Text_Parsing_StringParser_CodeUnits["char"]("-")))))(Data_Functor.map(Text_Parsing_StringParser.functorParser)(Data_Foldable.fold(Data_List_Types.foldableNonEmptyList)(Data_Monoid.monoidString))(Text_Parsing_StringParser_Combinators.many1(anyValidAndSpecialChar)));
      return Data_Functor.map(Data_Either.functorEither)(Data_Functor.map(Data_Functor.functorFn)(function (v) {
          return {
              className: className,
              name: v
          };
      })(Data_String_Extra.camelCase))(Text_Parsing_StringParser.runParser(nameParser)(className));
  };
  var parseFromFile = function (dictMonadEffect) {
      return function (cssPath) {
          return Control_Bind.bind((dictMonadEffect.Monad0()).Bind1())(Effect_Class.liftEffect(dictMonadEffect)(Node_FS_Sync.readTextFile(Node_Encoding.UTF8.value)(cssPath)))(function (cssContent) {
              return Control_Applicative.pure((dictMonadEffect.Monad0()).Applicative0())(Data_Functor.map(Data_Either.functorEither)(PseudoAst)(Data_Traversable.sequence(Data_Traversable.traversableArray)(Data_Either.applicativeEither)(Data_Functor.map(Data_Functor.functorArray)(nodeFromClassName)(Utils.getClassNames(cssContent)(cssPath)))));
          });
      };
  };
...
(function($PS) {
  ...
  var Text_Parsing_StringParser = $PS["Text.Parsing.StringParser"];
  var Utils = $PS["Utils"];                
  var formatFromFile = function (dictMonadEffect) {
      return function (dictMonadAsk) {
          return function (outputFile) {
              var formatFile = function (v) {
                  return Control_Bind.bind((dictMonadAsk.Monad0()).Bind1())(Utils.catchAndKill(dictMonadEffect)(Node_FS_Sync.readTextFile(Node_Encoding.UTF8.value)(Node_Globals["__dirname"] + ("/templates/" + (outputFile + ".hbs")))))(function (template) {
                      return Control_Applicative.pure((dictMonadAsk.Monad0()).Applicative0())(Text_Handlebars.compile(template)({
                          nodes: v
                      }));
                  });
              };
              return Control_Bind.bind((dictMonadAsk.Monad0()).Bind1())(Control_Bind.bind((dictMonadAsk.Monad0()).Bind1())(Control_Bind.bind((dictMonadAsk.Monad0()).Bind1())(Control_Monad_Reader_Class.asks(dictMonadAsk)(function (v) {
                  return v.cssOutput;
              }))(Parser.parseFromFile(dictMonadEffect)))(Data_Traversable.traverse(Data_Either.traversableEither)((dictMonadAsk.Monad0()).Applicative0())(formatFile)))(Data_Either.either((function () {
                  var $13 = Utils.kill(dictMonadEffect);
                  var $14 = Data_Show.show(Text_Parsing_StringParser.showParseError);
                  return function ($15) {
                      return $13(Effect_Exception.error($14($15)));
                  };
              })())(Control_Applicative.pure((dictMonadAsk.Monad0()).Applicative0())));
          };
      };
  };
  var save = function (dictMonadEffect) {
      return function (dictMonadLogger) {
          return function (dictMonadAsk) {
              var saveFile = function (output) {
                  return function (path) {
                      var $16 = Utils.catchAndKill(dictMonadEffect);
                      var $17 = Node_FS_Sync.writeTextFile(Node_Encoding.UTF8.value)(output + ("/" + path));
                      return function ($18) {
                          return $16($17($18));
                      };
                  };
              ...
              return Control_Bind.bind((dictMonadAsk.Monad0()).Bind1())(Control_Monad_Reader_Class.ask(dictMonadAsk))(function (v) {
                  if (v.lang instanceof Lang.PureScript) {
                      return Control_Bind.bind((dictMonadAsk.Monad0()).Bind1())(formatFromFile(dictMonadEffect)(dictMonadAsk)("purs"))(saveFile(v.output)("Tailwind.purs"));
                  };
                  if (v.lang instanceof Lang.Elm) {
                      return Control_Bind.bind((dictMonadAsk.Monad0()).Bind1())(formatFromFile(dictMonadEffect)(dictMonadAsk)("elm"))(saveFile(v.output)("Tailwind.elm"));
                  };
                  if (v.lang instanceof Lang.ReasonML) {
                      return Control_Bind.bind((dictMonadAsk.Monad0()).Bind1())(formatFromFile(dictMonadEffect)(dictMonadAsk)("re"))(function (code) {
                          return Control_Bind.bind((dictMonadAsk.Monad0()).Bind1())(formatFromFile(dictMonadEffect)(dictMonadAsk)("rei"))(function (codei) {
                              return Control_Bind.discard(Control_Bind.discardUnit)((dictMonadAsk.Monad0()).Bind1())(saveFile(v.output)("tailwind.re")(code))(function () {
                                  return saveFile(v.output)("tailwind.rei")(codei);
                              });
                          });
                      });
                  };
                  if (v.lang instanceof Lang.TypeScript) {
                      return Control_Bind.bind((dictMonadAsk.Monad0()).Bind1())(formatFromFile(dictMonadEffect)(dictMonadAsk)("ts"))(saveFile(v.output)("tailwind.ts"));
                  };
                  if (v.lang instanceof Lang.TypeScriptTypeLevel) {
                      return Control_Bind.bind((dictMonadAsk.Monad0()).Bind1())(formatFromFile(dictMonadEffect)(dictMonadAsk)("ts-type-level"))(saveFile(v.output)("tailwind.ts"));
                  };
                  throw new Error("Failed pattern match at Printer (line 42, column 3 - line 51, column 92): " + [ v.lang.constructor.name ]);
              });
          };
      };
  };
...
(function($PS) {
  ...
  var Utils = $PS["Utils"];                
  var main = (function () {
      var app = Control_Bind.bind(AppM.bindAppM)(Control_Monad_Reader_Class.ask(AppM.monadAskAppM(Type_Equality.refl)))(function (v) {
          return Control_Bind.discard(Control_Bind.discardUnit)(AppM.bindAppM)(Control_Monad_Logger_Class.info(AppM.monadLoggerAppM)(Data_Semigroup.append(Data_Map_Internal.semigroupMap(Data_Ord.ordString))(Data_Log_Tag.tag("Tailwind config file")(v.config))(Data_Semigroup.append(Data_Map_Internal.semigroupMap(Data_Ord.ordString))(Data_Log_Tag.tag("Css input file")(v.cssInput))(Data_Log_Tag.tag("Css output file")(v.cssOutput))))("Generating Tailwind css..."))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(AppM.bindAppM)(Utils.tailwindBuild(AppM.monadAffAppM)(v.config)(v.cssInput)(v.cssOutput))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(AppM.bindAppM)(Control_Monad_Logger_Class.info(AppM.monadLoggerAppM)(Data_Monoid.mempty(Data_Map_Internal.monoidMap(Data_Ord.ordString)))("Done generating Tailwind css."))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(AppM.bindAppM)(Utils.catchAndKill(AppM.monadEffectAppM)(Utils.mkdirp(Effect_Class.monadEffectEffect)(v.output)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(AppM.bindAppM)(Printer.save(AppM.monadEffectAppM)(AppM.monadLoggerAppM)(AppM.monadAskAppM(Type_Equality.refl)))(function () {
                              return Control_Monad_Logger_Class.info(AppM.monadLoggerAppM)(Data_Monoid.mempty(Data_Map_Internal.monoidMap(Data_Ord.ordString)))("Done");
                          });
                      });
                  });
              });
      ...
      return Effect_Aff.launchAff_(Control_Bind.bindFlipped(Effect_Aff.bindAff)(AppM.runAppM(app))(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Options_Applicative_Extra.execParser(Options.options))));
  })();
  exports["main"] = main;
})(PS);
PS["Main"].main();