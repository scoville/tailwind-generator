...
(function($PS) {
  ...
  var showVerbosity = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Verbosity (line 11, column 12 - line 14, column 21): " + [ v.constructor.name ]);
  });
  ...
  var runAppM = function (v) {
      return function (options) {
          var logMessage = function (message) {
              return Effect_Class.liftEffect(Control_Monad_Reader_Trans.monadEffectReader(Effect_Aff.monadEffectAff))(Control_Bind.bind(Effect.bindEffect)(Data_Log_Formatter_Pretty.prettyFormatter(Effect_Class.monadEffectEffect)(message))(Effect_Console.log));
          };
          ...
          return function (dictMonadLogger) {
              return function (outputFile) {
                  ...
                  return Control_Bind.bind((dictMonadAsk.Monad0()).Bind1())(Control_Bind.bind((dictMonadAsk.Monad0()).Bind1())(Control_Bind.bind((dictMonadAsk.Monad0()).Bind1())(Control_Monad_Reader_Class.asks(dictMonadAsk)(function (v) {
                      ...
                      var $14 = Utils.kill(dictMonadEffect);
                      var $15 = Data_Show.show(Text_Parsing_StringParser.showParseError);
                      return function ($16) {
                          return $14(Effect_Exception.error($15($16)));
                      };
          ...
          return function (dictMonadAsk) {
              var saveFile = function (output) {
                  return function (path) {
                      var $17 = Utils.catchAndKill(dictMonadEffect);
                      var $18 = Node_FS_Sync.writeTextFile(Node_Encoding.UTF8.value)(output + ("/" + path));
                      return function ($19) {
                          return $17($18($19));
                      };
                  };
              ...
              return Control_Bind.bind((dictMonadAsk.Monad0()).Bind1())(Control_Monad_Reader_Class.ask(dictMonadAsk))(function (v) {
                  if (v.lang instanceof Lang.PureScript) {
                      return Control_Bind.bind((dictMonadAsk.Monad0()).Bind1())(formatFromFile(dictMonadEffect)(dictMonadAsk)(dictMonadLogger)("purs"))(saveFile(v.output)("Tailwind.purs"));
                  };
                  if (v.lang instanceof Lang.Elm) {
                      return Control_Bind.bind((dictMonadAsk.Monad0()).Bind1())(formatFromFile(dictMonadEffect)(dictMonadAsk)(dictMonadLogger)("elm"))(saveFile(v.output)("Tailwind.elm"));
                  };
                  if (v.lang instanceof Lang.ReasonML) {
                      return Control_Bind.bind((dictMonadAsk.Monad0()).Bind1())(formatFromFile(dictMonadEffect)(dictMonadAsk)(dictMonadLogger)("re"))(function (code) {
                          return Control_Bind.bind((dictMonadAsk.Monad0()).Bind1())(formatFromFile(dictMonadEffect)(dictMonadAsk)(dictMonadLogger)("rei"))(function (codei) {
                  ...
                  if (v.lang instanceof Lang.TypeScript) {
                      return Control_Bind.bind((dictMonadAsk.Monad0()).Bind1())(formatFromFile(dictMonadEffect)(dictMonadAsk)(dictMonadLogger)("ts"))(saveFile(v.output)("tailwind.ts"));
                  };
                  if (v.lang instanceof Lang.TypeScriptTypeLevel) {
                      return Control_Bind.bind((dictMonadAsk.Monad0()).Bind1())(formatFromFile(dictMonadEffect)(dictMonadAsk)(dictMonadLogger)("ts-type-level"))(saveFile(v.output)("tailwind.ts"));
                  };
                  throw new Error("Failed pattern match at Printer (line 43, column 3 - line 52, column 92): " + [ v.lang.constructor.name ]);
              });
          };
      };
  };
      ...
      var app = Control_Bind.bind(AppM.bindAppM)(Control_Monad_Reader_Class.ask(AppM.monadAskAppM(Type_Equality.refl)))(function (v) {
          return Control_Bind.discard(Control_Bind.discardUnit)(AppM.bindAppM)(Control_Monad_Logger_Class.info(AppM.monadLoggerAppM)(Data_Semigroup.append(Data_Map_Internal.semigroupMap(Data_Ord.ordString))(Data_Log_Tag.tag("Tailwind config file")(v.config))(Data_Semigroup.append(Data_Map_Internal.semigroupMap(Data_Ord.ordString))(Data_Log_Tag.tag("Css input file")(v.cssInput))(Data_Log_Tag.tag("Css output file")(v.cssOutput))))("Generating Tailwind css..."))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(AppM.bindAppM)(Utils.tailwindBuild(AppM.monadAffAppM)(v.config)(v.cssInput)(v.cssOutput))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(AppM.bindAppM)(Control_Monad_Logger_Class.info(AppM.monadLoggerAppM)(Data_Map_Internal.empty)("Done generating Tailwind css."))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(AppM.bindAppM)(Utils.catchAndKill(AppM.monadEffectAppM)(Utils.mkdirp(Effect_Class.monadEffectEffect)(v.output)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(AppM.bindAppM)(Printer.save(AppM.monadEffectAppM)(AppM.monadLoggerAppM)(AppM.monadAskAppM(Type_Equality.refl)))(function () {
                              return Control_Monad_Logger_Class.info(AppM.monadLoggerAppM)(Data_Map_Internal.empty)("Done");
                          });
                      });
                  });
              });
