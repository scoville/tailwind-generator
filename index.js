...
(function($PS) {
  ...
  var runAppM = function (v) {
      return function (options) {
          var logMessage = function (v1) {
              if (options.verbose) {
                  return Effect_Class.liftEffect(Control_Monad_Reader_Trans.monadEffectReader(Effect_Aff.monadEffectAff))(Effect_Console.info(v1.message));
              };
              ...
              throw new Error("Failed pattern match at AppM (line 47, column 3 - line 49, column 28): " + [ v1.constructor.name ]);
          };
          return Control_Monad_Reader_Trans.runReaderT(Control_Monad_Logger_Trans.runLoggerT(v)(logMessage))(options);
      };
  };                                                                                                                                        
...
(function($PS) {
  ...
  var main = (function () {
      var app = Control_Bind.bind(AppM.bindAppM)(Control_Monad_Reader_Class.ask(AppM.monadAskAppM(Type_Equality.refl)))(function (v) {
          return Control_Bind.discard(Control_Bind.discardUnit)(AppM.bindAppM)(Control_Monad_Logger_Class.info(AppM.monadLoggerAppM)(Data_Map_Internal.empty)("Building Tailwind css"))(function () {
