...
use crate::lang::elm::ElmTemplate;
use crate::lang::purescript::PurescriptTemplate;
use crate::lang::rescript::{RescriptTemplate, RescriptiTemplate};
use crate::lang::typescript::TypescriptTemplate;
...
struct Opts {
    ...
    #[clap(short = 'f', long, default_value = "Tailwind")]
