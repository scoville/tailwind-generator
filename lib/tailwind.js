...
var loadAdapters = function () { return __awaiter(_this, void 0, void 0, function () {
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = {};
                return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("./adapters/elm")); })];
            case 1:
                _a.elm = _b.sent();
                return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("./adapters/reasonml")); })];
            case 2:
                _a.reasonml = _b.sent();
                return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("./adapters/typescript")); })];
            case 3: return [2 /*return*/, (_a.typescript = _b.sent(),
                    _a)];
        }
    });
}); };
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, utils.shutDownLog(function () { return __awaiter(_this, void 0, void 0, function () {
...
cli.option("-l, --lang <lang>", "Language used in generated code (elm|reasonml|typescript)");
