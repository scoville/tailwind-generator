...
var loadAdapters = function () {
    return langs_1.default.reduce(function (agg, lang) {
        var _a;
        return (__assign({}, agg, (_a = {}, _a[lang] = Promise.resolve().then(function () { return __importStar(require("./adapters/" + lang)); }), _a)));
    }, 
...
cli.option("-l, --lang <lang>", "Language used in generated code (elm|reasonml|typescript|purescript)");
